...
var userController = {
  ...
  init: function (config) {
    ...
    this.uiElements.loginButton2 = $("#auth0-login2");
    this.uiElements.logoutButton = $("#auth0-logout");
    this.uiElements.profileButton = $("#user-profile");
    this.uiElements.profileNameLabel = $("#profilename");
    this.uiElements.profileImage = $("#profilepicture");
    this.uiElements.loginContent = $("#loginContent-hide");
  ...
  showUserAuthenticationDetails: function (profile) {
    ...
    this.uiElements.loginButton2.toggle(!showAuthenticationElements);
    this.uiElements.logoutButton.toggle(showAuthenticationElements);
    this.uiElements.profileButton.toggle(showAuthenticationElements);
    this.uiElements.loginContent.toggle(showAuthenticationElements)
  },
  // 특정 이벤트에 반응하는 함수를 정의
  wireEvents: function () {
    var that = this;
    ...
    this.data.auth0Lock.on("authenticated", function (authResult) {
      ...
      that.data.auth0Lock.getUserInfo(
    ...
    this.uiElements.loginButton2.click(function (e) {
      that.data.auth0Lock.show();
    });
    // 로그아웃 버튼을 클릭했을 때 처리
    ...
    this.uiElements.logoutButton.click(function (e) {
      ...
      that.uiElements.loginContent.hide();
      that.uiElements.loginButton.show();
      that.uiElements.loginButton2.show();
    });
  },
};
